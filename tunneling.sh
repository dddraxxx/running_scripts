...
./code tunnel --accept-server-license-terms --install-extension ms-python.python --install-extension ms-toolsai.jupyter --install-extension eamodio.gitlens --install-extension augment.vscode-augment | tee vscode_tunnel.log
